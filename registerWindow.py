...
"font-size: 20px;")
        ...
        self.password_repeat = QtWidgets.QLineEdit(parent=self.widget)
        self.password_repeat.setStyleSheet("background-color: rgb(200, 200, 200);\n"
"margin: 0 50px;\n"
"height: 30px;\n"
"padding: 10px 0 10px 20px;\n"
"border-radius: 10px;\n"
...
"font-size: 20px;")
        ...
        self.verticalLayout_2.addWidget(self.password_repeat)
        ...
        self.reg_button.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(_translate("MainWindow", "Регистрация"))
        ...
        self.password_repeat.setPlaceholderText(_translate("MainWindow", "Повтор пароля"))
        self.reg_button.setText(_translate("MainWindow", "Зарегистрироваться"))
        self.recovery_button.setText(_translate("MainWindow", "вернуться в главное меню"))
