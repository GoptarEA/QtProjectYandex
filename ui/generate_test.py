...
"")
        ...
        self.choose_place = QtWidgets.QPushButton(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Play")
        font.setPointSize(14)
        self.choose_place.setFont(font)
        self.choose_place.setStyleSheet("background-color: white;\n"
"padding: 10px 20px;\n"
"")
        self.choose_place.setObjectName("choose_place")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.choose_place)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Формат выходного файла"))
        self.label_5.setText(_translate("MainWindow", "C:/Users/Document"))
        self.choose_place.setText(_translate("MainWindow", "Выбрать папку для сохранения"))
